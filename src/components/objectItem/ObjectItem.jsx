...
const ObjectItem = ({item, objects, setObjects, setSuccess, setResponseActive}) => {
  ...
  return (<>
    ...
    <div className="user__item">
        ...
        <div className={item.status.id === 4 ? "user__item__status" : item.status.id === 3 ?  "user__item__status develop" : "user__item__status pending__funding"}> {item.status.name}</div>
        <div>
