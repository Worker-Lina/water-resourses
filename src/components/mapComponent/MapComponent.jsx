...
const MapComponent = ({textVisible, setTextVisible, props, location, setLocation, fullScreenButton}) => {
 ...
 // функция которая увеличивает карту на весь экран
  ...
  return(<div className="map__container">
     <MapContainer whenCreated={ mapInstance => { 
      ...
      {fullScreenButton ? <div className="full-screen" onClick={mapToFullScreen}><svg className="full-screen-svg"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {fullScreenButton ? <></> : <LocationMarker/>}
    </MapContainer> 
