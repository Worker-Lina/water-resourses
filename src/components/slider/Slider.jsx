    ...
    return (
            <div className="slider">
                        ...
                        {index ===current && (
                            <div className="player-video" onClick={()=>{setActive(true)}}>
                                {image.url && image !==null && image.url !==" " ? 
                                    <img  src={"https://dev14.panama.kz" + image.url} alt="travel" className="slider-img"/> :
                                    checkurl(image) ? 
                ...
                <div id="nav" className="slider__nav">
                        <svg className="icon-slider" onClick={prevSlide} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="slider__nav-text">{current+1}/{length}</p>
                        <svg className="icon-slider" onClick={nextSlide} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
