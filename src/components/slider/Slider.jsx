    ...
    return (
            <div className="slider">
                ...
                <div id="nav" className="slider__nav">
                        ...
                        <svg className="icon" onClick={prevSlide} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="slider__nav-text">{current+1}/{length}</p>
                        <svg className="icon" onClick={nextSlide} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
