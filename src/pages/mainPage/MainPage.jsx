...
const MainPage = () => {  
  ...
  return <div className="mainPage">
      <Helmet>
          <title>Водные ресурсы Туркестана</title>
          <meta name="keywords" content="водные ресурсы туркестана, водные ресурсы, водохранилища, каналы, Туркестан"></meta>
          <meta name="description" content="Водные ресурсы туркестана"></meta>
      </Helmet>
